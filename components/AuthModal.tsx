...
// ... (İKONLAR AYNI - Burayı kısaltmıyorum, olduğu gibi kullanabilirsin) ...
...
export default function AuthModal({ isOpen, onClose, onLoginSuccess }: AuthModalProps) {
  ...
  // --- GÜNCELLENEN KAYIT FONKSİYONU (TÜM ALANLARI OLUŞTURUR) ---
  const handleRegister = (e: React.FormEvent) => {
    ...
    // DÜZELTME: Telefon, Cinsiyet, Doğum Tarihi alanlarını boş olarak başlatıyoruz
